...
enum _Godot3_Variant_Type {
	...
	TYPE_DICTIONARY = 18,
	TYPE_ARRAY = 19,
	TYPE_PACKED_BYTE_ARRAY = 20,
	TYPE_PACKED_INT32_ARRAY = 21,
	TYPE_PACKED_FLOAT32_ARRAY = 22,
	TYPE_PACKED_STRING_ARRAY = 23,
	TYPE_PACKED_VECTOR2_ARRAY = 24,
	TYPE_PACKED_VECTOR3_ARRAY = 25,
	TYPE_PACKED_COLOR_ARRAY = 26,
}
...
const _MAP_TYPE_3_TO_4: Dictionary = {
	...
	_Godot3_Variant_Type.TYPE_FLOAT: TYPE_FLOAT,
	...
	_Godot3_Variant_Type.TYPE_QUATERNION: TYPE_QUATERNION,
	_Godot3_Variant_Type.TYPE_AABB: TYPE_AABB,
	_Godot3_Variant_Type.TYPE_BASIS: TYPE_BASIS,
	_Godot3_Variant_Type.TYPE_TRANSFORM3D: TYPE_TRANSFORM3D,
	...
	_Godot3_Variant_Type.TYPE_PACKED_BYTE_ARRAY: TYPE_PACKED_BYTE_ARRAY,
	_Godot3_Variant_Type.TYPE_PACKED_INT32_ARRAY: TYPE_PACKED_INT32_ARRAY,
	_Godot3_Variant_Type.TYPE_PACKED_FLOAT32_ARRAY: TYPE_PACKED_FLOAT32_ARRAY,
	_Godot3_Variant_Type.TYPE_PACKED_STRING_ARRAY: TYPE_PACKED_STRING_ARRAY,
	_Godot3_Variant_Type.TYPE_PACKED_VECTOR2_ARRAY: TYPE_PACKED_VECTOR2_ARRAY,
	_Godot3_Variant_Type.TYPE_PACKED_VECTOR3_ARRAY: TYPE_PACKED_VECTOR3_ARRAY,
	_Godot3_Variant_Type.TYPE_PACKED_COLOR_ARRAY: TYPE_PACKED_COLOR_ARRAY,
}
